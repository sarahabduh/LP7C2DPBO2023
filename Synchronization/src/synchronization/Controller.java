    ...
    public synchronized void keyReleased(KeyEvent e) {
        ...
        if (game.isRunning()) {
            ...
            if ((key == KeyEvent.VK_W) || (key == KeyEvent.VK_UP)) {
                ...
                // Adds score if the next pressed key is not the same as the previous one
                if ((this.nextKey != KeyEvent.VK_W) && (this.nextKey != KeyEvent.VK_UP)) {
                    currentScore++;
            ...
            if ((key == KeyEvent.VK_A) || (key == KeyEvent.VK_LEFT)) {
                ...
                // Adds score if the next pressed key is not the same as the previous one
                if ((this.nextKey != KeyEvent.VK_A) && (this.nextKey != KeyEvent.VK_LEFT)) {
                    currentScore++;
                    game.setScore(currentScore);
                    this.nextKey = key;
                }
            ...
            if ((key == KeyEvent.VK_S) || (key == KeyEvent.VK_DOWN)) {
                ...
                // Adds score if the next pressed key is not the same as the previous one
                if ((this.nextKey != KeyEvent.VK_S) && (this.nextKey != KeyEvent.VK_DOWN)) {
                    currentScore++;
                    game.setScore(currentScore);
                    this.nextKey = key;
                }
            ...
            if ((key == KeyEvent.VK_D) || (key == KeyEvent.VK_RIGHT)) {
                ...
                // Adds score if the next pressed key is not the same as the previous one
                if ((this.nextKey != KeyEvent.VK_D) && (this.nextKey != KeyEvent.VK_RIGHT)) {
                    currentScore++;
                    game.setScore(currentScore);
                    this.nextKey = key;
                }
